...
# Time complexity 1 for all operations
# Space complexity P+S^2 where P is checkin, S is stations, we could reasonably expect every possible pair of the S stations on the network to have an entry in this HashMap, which would be S^2
